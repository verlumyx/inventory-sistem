...
import { ArrowLeft, Plus, Trash2, Receipt, Package, Calculator } from 'lucide-react';
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Selecciona el almacén para la factura
                                </CardDescription>
                            </CardHeader>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Agrega items a la factura de forma rápida y dinámica
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
