...
class Item extends Model
{
    ...
    /**
     * Get the warehouse items for this item.
     */
    ...
    /**
     * Get the warehouses that have this item through the pivot table.
     */
    ...
    /**
     * Get warehouses that have stock of this item.
     */
    public function warehousesWithStock(): BelongsToMany
    {
        return $this->warehouses()->wherePivot('quantity_available', '>', 0);
    }
    ...
    {
        return $this->warehouseItems()->sum('quantity_available');
    }
